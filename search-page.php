...
<main class="grid-container">
    <section>
        ...
        <form method="get" action="browse-search-result-page.php">
            <div>
                <input type="radio" id="title-rad" name="search-rad" checked>
            ...
            <div>
                ...
                <label for="year-rad">Year</label>
                    <div>
                            <input for="year-rad" type="radio" id="year-rad-less" name="years-rad" value="off">
                            <label for="year-rad-less">Less</label>
                            <input for="year-rad-less" type="number" id="year-less" name="year-less">
                            <input type="radio" id="year-rad-great" name="years-rad" value="off">
            ...
            <div>
                ...
                <label for="pop-rad">Popularity</label>
                    <div>
                            <input for="pop-rad" type="radio" id="pop-rad-less" name="popu-rad" value="off">
                            <label for="pop-rad-less">Less</label>
                            <input for="pop-rad-less" type="number" id="pop-less" name="pop-less">
                            <input type="radio" id="pop-rad-great" name="popu-rad" value="off">
